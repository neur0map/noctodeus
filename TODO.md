...
- [x] MCP server (nodeus-mcp binary: 9 tools for external AI agents to read/search/write notes)
...
- [x] Nodeus as MCP server setup instructions in settings (copy-to-clipboard config)
